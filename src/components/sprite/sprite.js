...
const Sprite = () => {
    ...
    const rotateApear = roateNum.map((e,index) => (<Circle key={index} rotateValue={rotate * e} color={rotate * e} color1={rotate * e / 3}></Circle>)) // map 함수를 통한 다중 컴포넌트 출력
    return (
        <>
            <sprite.menuBar>
                ...
                <a href="https://github.com/jidole02/study-react/tree/master/react-project/src/components/sprite"><i className="fab fa-github"></i></a>
            </sprite.menuBar>
            <sprite.cont>
